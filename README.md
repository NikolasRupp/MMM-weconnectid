...
| force_enable_access | If you don't get the status of your doors and windows try setting this to "true"                                                                                       | "true", "false"                               | "false"                                                                                                                                                                                                                        | no                               | Text    |
...
| Value               | Description                                                                        |
|---------------------|------------------------------------------------------------------------------------|
| bonnetDoor          | Status of the Bonnet Door                                                          |
| trunkDoor           | Status of the Trunk Door                                                           |
| frontLeftDoor       | Status of the Front Left Door                                                      |
| frontRightDoor      | Status of the Front Right Door                                                     |
| rearLeftDoor        | Status of the Rear Left Door                                                       |
| rearRightDoor       | Status of the Rear Right Door                                                      |
| overallStatus       | If the Vehicle is locked                                                           |
| frontLeftWindow     | Status of the Front Left Window                                                    |
| frontRightWindow    | Status of the Front Right Window                                                   |
| rearLeftWindow      | Status of the Rear Left Window                                                     |
| rearLRightWindow    | Status of the Rear Right Window                                                    |
